...
const Button = forwardRef<HTMLButtonElement, ButtonProps>((props, ref) => {
    ...
    const twoToneColor = () => {
        const btn = {
            bgColor: active
                ? `bg-${buttonColor}-200 dark:bg-${buttonColor}-50 border border${buttonColor}-${buttonColorLevel}`
                : `bg-${buttonColor}-50 dark:bg-${buttonColor}-500 dark:bg-opacity-20 border border-${buttonColor}-${buttonColorLevel}`,
